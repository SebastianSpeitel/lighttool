...
if (inBrowser && !isIE) {
  var performance$2 = window.performance;
  if (
    performance$2 &&
    typeof performance$2.now === 'function' &&
    ...
    // well.
    getNow = function () { return performance$2.now(); };
  }
}
...
// Styles
const baseMixins$7 = mixins(BindsAttrs, Validatable);
/* @vue/component */

var VInput = baseMixins$7.extend().extend({
  name: 'v-input',
  inheritAttrs: false,
  props: {
    appendIcon: String,
...
const baseMixins$8 = mixins(Colorable, factory(['absolute', 'fixed', 'top', 'bottom']), Proxyable, Themeable);
/* @vue/component */

var VProgressLinear = baseMixins$8.extend({
...
// Styles
const baseMixins$9 = mixins(VInput, intersectable({
  onVisible: ['setLabelWidth', 'setPrefixWidth', 'setPrependWidth']
}), Loadable);
const dirtyTypes = ['color', 'file', 'time', 'date', 'datetime-local', 'week', 'month'];
/* @vue/component */

var VTextField = baseMixins$9.extend().extend({
  name: 'v-text-field',
  directives: {
    ripple: Ripple
  },
...
const baseMixins$a = mixins(VTextField, Comparable, Filterable);
/* @vue/component */

var VSelect = baseMixins$a.extend().extend({
  name: 'v-select',
  directives: {
    ClickOutside
  },
...
mixins(VSheet, Toggleable).extend({
  name: 'v-banner',
  inheritAttrs: false,
  props: {
    app: Boolean,
...
// Styles
const baseMixins$b = mixins(Activatable, Dependent, Detachable, Overlayable, Returnable, Stackable, Toggleable);
/* @vue/component */

var VDialog = baseMixins$b.extend({
  name: 'v-dialog',
  directives: {
    ClickOutside
  },
...
// Mixins
const baseMixins$c = mixins(Bootable, factory$2('windowGroup', 'v-window-item', 'v-window'));
var VWindowItem = baseMixins$c.extend().extend().extend({
  name: 'v-window-item',
  directives: {
    Touch
  },
...
const baseMixins$d = mixins(VWindowItem, Routable);
/* @vue/component */
...
Selectable.extend({
  ...
  methods: {
    genCheckbox() {
      ...
      }), this.genRipple(this.setTextColor(this.validationState)), this.$createElement(VIcon$1, this.setTextColor(this.validationState, {
        props: {
          dense: this.dense,
          dark: this.dark,
          light: this.light
...
function extractColor(color, input) {
  ...
  if (typeof input === 'object') {
    if (has$1(input, ['r', 'g', 'b'])) return color.rgba;else if (has$1(input, ['h', 's', 'l'])) return color.hsla;else if (has$1(input, ['h', 's', 'v'])) return color.hsva;
  }
...
var VPicker = mixins(Colorable, Themeable).extend({
  name: 'v-picker',
  props: {
    fullWidth: Boolean,
    landscape: Boolean,
...
// Components
var Picker = mixins(Colorable, Themeable
/* @vue/component */
).extend({
  name: 'picker',
  props: {
...
const baseMixins$f = mixins(Bootable, Colorable, inject('expansionPanel', 'v-expansion-panel-content', 'v-expansion-panel'));
/* @vue/component */
...
// Components
const baseMixins$g = mixins(Colorable, inject('expansionPanel', 'v-expansion-panel-header', 'v-expansion-panel'));
...
// Styles
const baseMixins$h = mixins(applicationable('left', ['isActive', 'isMobile', 'miniVariant', 'expandOnHover', 'permanent', 'right', 'temporary', 'width']), Colorable, Dependent, Overlayable, SSRBootable, Themeable);
/* @vue/component */
...
mixins(Colorable, Themeable).extend({
  name: 'v-pagination',
  directives: {
    Resize
  },
...
// Style
const baseMixins$i = mixins(Translatable);
/* @vue/component */

baseMixins$i.extend().extend({
  name: 'v-parallax',
  props: {
    alt: {
      type: String,
...
// Styles
const baseMixins$j = mixins(Comparable, BaseItemGroup, VInput);
/* @vue/component */
...
// Styles
const baseMixins$k = mixins(BindsAttrs, Colorable, Rippleable, factory$2('radioGroup'), Themeable);
/* @vue/component */

baseMixins$k.extend().extend({
  name: 'v-radio',
  inheritAttrs: false,
  props: {
    disabled: Boolean,
...
// Styles
var VSnackbar = mixins(Colorable, Toggleable, factory(['absolute', 'top', 'bottom', 'left', 'right'])
/* @vue/component */
).extend({
  name: 'v-snackbar',
  props: {
...
// Styles
const baseMixins$l = mixins(provide('stepper'), Proxyable, Themeable);
/* @vue/component */

var VStepper = baseMixins$l.extend({
  name: 'v-stepper',
...
// Components
const baseMixins$m = mixins(Colorable, inject('stepper', 'v-stepper-step', 'v-stepper'));
/* @vue/component */

var VStepperStep = baseMixins$m.extend().extend({
  name: 'v-stepper-step',
  directives: {
    ripple: Ripple
  },
...
// Components
const baseMixins$n = mixins(inject('stepper', 'v-stepper-content', 'v-stepper'));
/* @vue/component */
...
// Styles
const baseMixins$o = mixins(Colorable, Proxyable, Themeable);
...
// Mixins
const baseMixins$p = mixins(Routable, // Must be after routable
// to overwrite activeClass
factory$2('tabsBar'), Themeable);
baseMixins$p.extend().extend().extend({
  name: 'v-tab',
  props: {
    ripple: {
      type: [Boolean, Object],
...
// Styles
const baseMixins$q = mixins(VTextField);
/* @vue/component */
...
// Types
const baseMixins$r = mixins(Colorable, Themeable
/* @vue/component */
);
baseMixins$r.extend().extend({
...
// Components
const baseMixins$s = mixins(Colorable, inject('treeview'));
...
const VTreeviewNode = baseMixins$s.extend().extend({
...
export { Component as C, Vue as V, __assign as _, __extends as a, __decorate as b, VStepper as c, VStepperHeader as d, VStepperStep as e, VDivider as f, global$1 as g, normalizeComponent as h, VAppBar as i, VToolbarTitle as j, VApp as k, VContent as l, VContainer as m, VCard as n, VSpacer as o, process as p, Vuetify as q, VTextField as r, __awaiter as s, VIcon$1 as t, VBtn as u, VFabTransition as v, VSnackbar as w, __generator as x };
//# sourceMappingURL=normalize-component-17454685.js.map
